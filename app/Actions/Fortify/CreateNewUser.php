...
class CreateNewUser implements CreatesNewUsers
{
    ...
    public function create(array $input)
    {
        $validationRules = [
            ...
            'referal' => ['required', 'string', 'alpha_num', 'min:6'],
            'password' => [
                'required',
                Password::min(8)
                    ->letters()
        ...
        $messages = [
            ...
            'referal.required' => 'referal is required.',
            'referal.string' => 'referal must be a string.',
            'referal.alpha_num' => 'referal must be alphanumeric.',
            'referal.min' => 'referal must be at least 6 characters.',
        ...
        if ($referBy) {
            ...
            $referUser = User::where('username', $input['referal'])->first();
        }
