                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div>
                            <div>
                                ...
                                <x-jet-input id="firstname" class="block mt-1 w-full" type="text" name="firstname"
                                    :value="old('firstname')" required autofocus autocomplete="given-name" placeholder="Firstname"/>
                            </div>
                        ...
                        <div>
                            <div>
                                ...
                                <x-jet-input id="lastname" class="block mt-1 w-full" type="text" name="lastname"
                                    :value="old('lastname')" required autocomplete="family-name" placeholder="Lastname"/>
                            </div>
                        ...
                        <div>
                            <div>
                                ...
                                <x-jet-input id="referal" class="block mt-1 w-full" type="text" name="referal"
                                    :value="old('referal')" required autocomplete="username" placeholder="Referal"/>
                            </div>
