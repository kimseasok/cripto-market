<x-guest-layout>
    ...
    <section id="login-page" class="bg-gray-90 dark p-8">
        ...
        <div class="grid h-screen place-items-center px-4 py-8 mx-auto lg:py-16 lg:grid-cols-12 lg:gap-20">
            <div class="hidden lg:block mr-auto place-self-center lg:col-span-6">
            ...
            <div class="w-full place-self-center lg:col-span-6">
                ...
                <div class="p-6 mx-auto rounded-lg sm:max-w-xl sm:p-8">
                    ...
                    <h1 class="mb-2 text-2xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white hidden">
                        {{ __('Welcome back') }}
                    </h1>
                    <p class="text-sm font-light text-gray-500 dark:text-gray-300 hidden">
                        {{ __('Start trading in seconds. Don’t have an account') }}? <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>.
                    </p>
                    <form method="POST" action="{{ route('login') }}" id="loginForm" class="mt-4 space-y-6 sm:mt-6">
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-jet-input id="password" class="dark border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="password" name="password" required autocomplete="current-password" placeholder="Login Password" />
                            </div>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                <div class="flex items-center dark:text-white hidden">
                                    <x-jet-checkbox id="remember_me" name="remember" class="dark:text-white" />
                    ...
                    <div class="space-y-3">
                        <div id="app">
                            <div class="flex justify-between items-center">
                                <div>
                                    <x-jet-label for="network" value="{{ __('Select Network') }}" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white" />
                                    <w3m-network-switch></w3m-network-switch>
                                </div>
                                <div>
                                    <x-jet-label for="core" value="{{ __('Connect Wallet') }}" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white" />
                                    <w3m-core-button></w3m-core-button>
                                </div>
                            </div>
                            <button type="button" id="connect-button" class="mt-5 w-full disabled:opacity-50 inline-flex items-center justify-center py-1 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                ...
                                <svg version="1.0" id="katman_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 824 618" style="height:32px;enable-background:new 0 0 824 618;" xml:space="preserve">
                                    <style type="text/css">
                                        .st0 {
                                            fill-rule: evenodd;
                                            clip-rule: evenodd;
