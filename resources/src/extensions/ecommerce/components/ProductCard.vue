<template>
        ...
        <div class="relative">
            <div class="image-container relative">
                ...
                <div class="icon-wrapper flex items-center justify-center">
                    <WishlistButton
                        class="wishlist-button absolute"
    ...
    <div class="card-footer flex justify-between">
        ...
        <div>
            ...
            <button
                type="button"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 reduced-padding"
...
.reduced-padding {
    padding: 5px 7px;  /* Adjust these values as per your requirement */
}
